...
// Build_59 - 部署更新
console.log('SettingsModal loaded - Build_59')
...
// 使用 ref + watch 确保响应式
const currentLocale = ref<Locale>(props.locale || 'zh')
    ...
    <div class="relative bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl w-full sm:max-w-md max-h-[85vh] overflow-hidden animate-slide-up sm:animate-scale-in">
      ...
      <div class="p-4 space-y-3 overflow-y-auto max-h-[calc(85vh-80px)] sm:max-h-[60vh]">
        ...
        <div class="text-center pt-4 pb-2">
          <button @click="handleVersionClick" class="text-xs text-gray-400 hover:text-gray-500">PhotoWall Build_59</button>
        </div>
